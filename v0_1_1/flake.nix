{
  ...
  inputs.src-nexus-v0_1_1.flake = false;
  inputs.src-nexus-v0_1_1.ref   = "refs/tags/v0.1.1";
  inputs.src-nexus-v0_1_1.owner = "jfilby";
  inputs.src-nexus-v0_1_1.repo  = "nexus";
  inputs.src-nexus-v0_1_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nexus-v0_1_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nexus-v0_1_1";
