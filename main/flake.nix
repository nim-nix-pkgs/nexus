{
  ...
  inputs.src-nexus-main.flake = false;
  inputs.src-nexus-main.ref   = "refs/heads/main";
  inputs.src-nexus-main.owner = "jfilby";
  inputs.src-nexus-main.repo  = "nexus";
  inputs.src-nexus-main.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nexus-main"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nexus-main";
